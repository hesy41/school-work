...
public:
  ...
  // Constructor with an int as the parameter
  // Create an array with size of the parameter
  ...
  //Overload index operator[] to return the reference of i-th element in the list.
